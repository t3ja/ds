...
DirectedGraph.prototype.removeElementFromArray = function(arr, v){
    
}

DirectedGraph.prototype.calculatePathWeight = function(path){
...
DirectedGraph.prototype.removeVertex = function(v){
    
}

DirectedGraph.prototype.hasVertex = function(v){
    
}

DirectedGraph.prototype.countVertices = function(){
    
}

DirectedGraph.prototype.visitDFS = function(){
    
}

DirectedGraph.prototype.getSeparatedVertices = function(arr, v){
    
}

DirectedGraph.prototype.addDirection = function(v1, v2, weight){
    
}

DirectedGraph.prototype.hasDirection = function(v1, v2){
    
}

DirectedGraph.prototype.getDirectionWeight = function(v1, v2){
    
}

DirectedGraph.prototype.findShortestPath = function(v1, v2, path, visited){
